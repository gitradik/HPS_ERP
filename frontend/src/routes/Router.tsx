...
const UserProfileContainer = Loadable(
  lazy(() => import('../views/apps/user-profile/UserProfileContainer')),
);
const UserProfileUsersContainer = Loadable(
  lazy(() => import('../views/apps/user-profile/UserProfileUsersContainer')),
);
